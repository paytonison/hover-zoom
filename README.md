...
- `src/Image Popout (Safari)-2.1.1.user.js`: the userscript to install.
...
3. Create a new userscript from
   `src/Image Popout (Safari)-2.1.1.user.js`.
...
Edit `src/Image Popout (Safari)-2.1.1.user.js` directly, reload the userscript in
...
```sh
node --check 'src/Image Popout (Safari)-2.1.1.user.js'
```
